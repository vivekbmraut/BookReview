    ...
    public class ReviewerService
    {
        ...
        public static Boolean Add(Reviewer reviewer)
        {
            try
            {
                ...
                string query = $"insert into reviewer values(NULL,\"{reviewer.name}\",\"{reviewer.email}\",SHA2(\"{reviewer.password}\",224),\"{reviewer.profile_pic}\",{reviewer.total_reviews},{reviewer.blocked_reviews},{reviewer.is_suspended});";
